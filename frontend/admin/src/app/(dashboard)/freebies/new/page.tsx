...
export default function NewFreebiePage() {
  return (
    <div className="max-w-2xl space-y-5">
      <div className="flex items-center gap-2">
        ...
        <span className="text-sm text-text">New Freebie</span>
      </div>
      <h1 className="text-2xl font-display font-semibold text-text">Add Freebie</h1>
